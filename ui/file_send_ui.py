...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.down_file_block_btn_4.setGeometry(QtCore.QRect(630, 266, 71, 27))
        ...
        self.set_hex_btn = QtWidgets.QPushButton(Dialog)
        self.set_hex_btn.setGeometry(QtCore.QRect(630, 234, 71, 27))
        self.set_hex_btn.setObjectName("set_hex_btn")
        self.rf_gongcan_btn = QtWidgets.QPushButton(Dialog)
        self.rf_gongcan_btn.setGeometry(QtCore.QRect(630, 360, 71, 27))
        self.rf_gongcan_btn.setObjectName("rf_gongcan_btn")
        self.gongcan_download_time_cb = QtWidgets.QComboBox(Dialog)
        self.gongcan_download_time_cb.setGeometry(QtCore.QRect(440, 360, 131, 27))
        self.gongcan_download_time_cb.setObjectName("gongcan_download_time_cb")
        self.gongcan_download_time_cb.addItem("")
        self.gongcan_download_time_cb.addItem("")
        self.gongcan_download_time_cb.addItem("")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.cmd_channel.setItemText(0, _translate("Dialog", "0-AB机均执行"))
        self.cmd_channel.setItemText(1, _translate("Dialog", "1-A机指令"))
        self.cmd_channel.setItemText(2, _translate("Dialog", "2-B机指令"))
        self.cmd_channel.setItemText(3, _translate("Dialog", "6-星务指令"))
        ...
        self.set_hex_btn.setText(_translate("Dialog", "Send Hex"))
        self.rf_gongcan_btn.setText(_translate("Dialog", "发送指令"))
        self.gongcan_download_time_cb.setItemText(0, _translate("Dialog", "30s工参下传-开"))
        self.gongcan_download_time_cb.setItemText(1, _translate("Dialog", "30s工参下传-关"))
        self.gongcan_download_time_cb.setItemText(2, _translate("Dialog", "射频通道关闭"))
