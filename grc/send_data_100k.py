...
# Title: Frontend BBCR 100k
# Generated: Mon Nov 18 18:25:56 2019
##################################################
...
class send_data_100k(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Frontend BBCR 100k")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Frontend BBCR 100k")
        ...
        self.settings = Qt.QSettings("GNU Radio", "send_data_100k")
        ...
        self.samp_rate_1 = samp_rate_1 = 800e3
        ...
        self.tab.addTab(self.tab_widget_0, '401.58M (30)')
        self.tab_widget_1 = Qt.QWidget()
        self.tab_layout_1 = Qt.QBoxLayout(Qt.QBoxLayout.TopToBottom, self.tab_widget_1)
        self.tab_grid_layout_1 = Qt.QGridLayout()
        self.tab_layout_1.addLayout(self.tab_grid_layout_1)
        self.tab.addTab(self.tab_widget_1, '401.54M (31)')
        self.tab_widget_2 = Qt.QWidget()
        self.tab_layout_2 = Qt.QBoxLayout(Qt.QBoxLayout.TopToBottom, self.tab_widget_2)
        self.tab_grid_layout_2 = Qt.QGridLayout()
        self.tab_layout_2.addLayout(self.tab_grid_layout_2)
        self.tab.addTab(self.tab_widget_2, '401.62M (32)')
        self.tab_widget_3 = Qt.QWidget()
        self.tab_layout_3 = Qt.QBoxLayout(Qt.QBoxLayout.TopToBottom, self.tab_widget_3)
        self.tab_grid_layout_3 = Qt.QGridLayout()
        self.tab_layout_3.addLayout(self.tab_grid_layout_3)
        self.tab.addTab(self.tab_widget_3, '401.66M (33)')
        ...
        self.tab.addTab(self.tab_widget_4, 'Loop')
        ...
        self._tx_offset_line_edit.returnPressed.connect(
        	lambda: self.set_tx_offset(int(str(self._tx_offset_line_edit.text().toAscii()))))
        ...
        self.tab_grid_layout_4.addWidget(self._timing_loop_bw_win, 1, 0, 1, 1)
        for r in range(1, 2):
        ...
        self.tab_grid_layout_4.addWidget(self._phase_bw_win, 2, 0, 1, 1)
        for r in range(2, 3):
            self.tab_grid_layout_4.setRowStretch(r, 1)
        for c in range(0, 1):
            self.tab_grid_layout_4.setColumnStretch(c, 1)
        ...
        self.tab_grid_layout_4.addWidget(self._fll_bw_win, 0, 0, 1, 1)
        for r in range(0, 1):
            self.tab_grid_layout_4.setRowStretch(r, 1)
        for c in range(0, 1):
            self.tab_grid_layout_4.setColumnStretch(c, 1)
        ...
        self.tab_grid_layout_4.addWidget(self._equalizer_gain_win, 3, 0, 1, 1)
        for r in range(3, 4):
            self.tab_grid_layout_4.setRowStretch(r, 1)
        for c in range(0, 1):
            self.tab_grid_layout_4.setColumnStretch(c, 1)
        ...
        self.tab_grid_layout_3.addWidget(self._qtgui_number_sink_0_2_win, 0, 0, 1, 1)
        for r in range(0, 1):
        ...
        self.tab_grid_layout_2.addWidget(self._qtgui_number_sink_0_1_win, 0, 0, 1, 1)
        for r in range(0, 1):
        ...
        self.tab_grid_layout_1.addWidget(self._qtgui_number_sink_0_0_win, 0, 0, 1, 1)
        for r in range(0, 1):
        ...
        self.qtgui_freq_sink_x_0_0_2 = qtgui.freq_sink_c(
        	1024, #size
        	firdes.WIN_BLACKMAN_hARRIS, #wintype
        	0, #fc
        	if_rate, #bw
        ...
        self.qtgui_freq_sink_x_0_0_2.set_update_time(0.10)
        self.qtgui_freq_sink_x_0_0_2.set_y_axis(-100, 0)
        self.qtgui_freq_sink_x_0_0_2.set_y_label('Relative Gain', 'dB')
        self.qtgui_freq_sink_x_0_0_2.set_trigger_mode(qtgui.TRIG_MODE_FREE, 0.0, 0, "")
        self.qtgui_freq_sink_x_0_0_2.enable_autoscale(False)
        self.qtgui_freq_sink_x_0_0_2.enable_grid(False)
        self.qtgui_freq_sink_x_0_0_2.set_fft_average(1.0)
        self.qtgui_freq_sink_x_0_0_2.enable_axis_labels(True)
        self.qtgui_freq_sink_x_0_0_2.enable_control_panel(False)

        if not False:
          self.qtgui_freq_sink_x_0_0_2.disable_legend()

        if "complex" == "float" or "complex" == "msg_float":
          self.qtgui_freq_sink_x_0_0_2.set_plot_pos_half(not True)
        ...
        for i in xrange(2):
            if len(labels[i]) == 0:
                self.qtgui_freq_sink_x_0_0_2.set_line_label(i, "Data {0}".format(i))
            else:
                self.qtgui_freq_sink_x_0_0_2.set_line_label(i, labels[i])
            self.qtgui_freq_sink_x_0_0_2.set_line_width(i, widths[i])
            self.qtgui_freq_sink_x_0_0_2.set_line_color(i, colors[i])
            self.qtgui_freq_sink_x_0_0_2.set_line_alpha(i, alphas[i])

        self._qtgui_freq_sink_x_0_0_2_win = sip.wrapinstance(self.qtgui_freq_sink_x_0_0_2.pyqwidget(), Qt.QWidget)
        self.tab_grid_layout_3.addWidget(self._qtgui_freq_sink_x_0_0_2_win, 2, 0, 1, 1)
        for r in range(2, 3):
            self.tab_grid_layout_3.setRowStretch(r, 1)
        for c in range(0, 1):
            self.tab_grid_layout_3.setColumnStretch(c, 1)
        ...
        self.qtgui_freq_sink_x_0_0_1.set_y_axis(-100, 0)
        ...
        self.tab_grid_layout_2.addWidget(self._qtgui_freq_sink_x_0_0_1_win, 2, 0, 1, 1)
        for r in range(2, 3):
            self.tab_grid_layout_2.setRowStretch(r, 1)
        for c in range(0, 1):
            self.tab_grid_layout_2.setColumnStretch(c, 1)
        ...
        self.tab_grid_layout_1.addWidget(self._qtgui_freq_sink_x_0_0_0_win, 2, 0, 1, 1)
        for r in range(2, 3):
            self.tab_grid_layout_1.setRowStretch(r, 1)
        for c in range(0, 1):
            self.tab_grid_layout_1.setColumnStretch(c, 1)
        ...
        self.tab_grid_layout_3.addWidget(self._qtgui_const_sink_x_0_2_win, 1, 0, 1, 1)
        for r in range(1, 2):
            self.tab_grid_layout_3.setRowStretch(r, 1)
        for c in range(0, 1):
            self.tab_grid_layout_3.setColumnStretch(c, 1)
        ...
        self.tab_grid_layout_2.addWidget(self._qtgui_const_sink_x_0_1_win, 1, 0, 1, 1)
        for r in range(1, 2):
            self.tab_grid_layout_2.setRowStretch(r, 1)
        for c in range(0, 1):
            self.tab_grid_layout_2.setColumnStretch(c, 1)
        ...
        self.tab_grid_layout_1.addWidget(self._qtgui_const_sink_x_0_0_win, 1, 0, 1, 1)
        for r in range(1, 2):
            self.tab_grid_layout_1.setRowStretch(r, 1)
        for c in range(0, 1):
            self.tab_grid_layout_1.setColumnStretch(c, 1)
        ...
        self.low_pass_filter_0 = filter.fir_filter_ccf(1, firdes.low_pass(
        	1, if_rate, 10e3, 2e3, firdes.WIN_HAMMING, 6.76))
        self.lilacsat_vitfilt27_fb_0_3 = lilacsat.vitfilt27_fb()
        self.lilacsat_vitfilt27_fb_0_2 = lilacsat.vitfilt27_fb()
        self.lilacsat_vitfilt27_fb_0_1 = lilacsat.vitfilt27_fb()
        self.lilacsat_vitfilt27_fb_0_0_2 = lilacsat.vitfilt27_fb()
        self.lilacsat_vitfilt27_fb_0_0_1 = lilacsat.vitfilt27_fb()
        self.lilacsat_vitfilt27_fb_0_0_0 = lilacsat.vitfilt27_fb()
        self.lilacsat_vitfilt27_fb_0_0 = lilacsat.vitfilt27_fb()
        self.lilacsat_vitfilt27_fb_0 = lilacsat.vitfilt27_fb()
        self.lilacsat_plan13_cc_0_2 = lilacsat.plan13_cc(False, '1 99999U          18116.20394676  .00036833  00000-0  16699-2 0 00008', '2 99999 097.3996 199.1566 0012704 281.9916 248.9397 15.20802792000016', 126.62741524, 45.73288422, 200, 401440000, samp_rate, False, True)
        self.lilacsat_plan13_cc_0_1 = lilacsat.plan13_cc(False, '1 99999U          18116.20394676  .00036833  00000-0  16699-2 0 00008', '2 99999 097.3996 199.1566 0012704 281.9916 248.9397 15.20802792000016', 126.62741524, 45.73288422, 200, 401440000, samp_rate, False, True)
        self.lilacsat_plan13_cc_0_0 = lilacsat.plan13_cc(False, '1 99999U          18116.20394676  .00036833  00000-0  16699-2 0 00008', '2 99999 097.3996 199.1566 0012704 281.9916 248.9397 15.20802792000016', 126.62741524, 45.73288422, 200, 401440000, samp_rate, False, True)
        ...
        self.lilacsat_fec_encode_b_0 = lilacsat.fec_encode_b(214, 300, 100, False, False, False, False)
        self.lilacsat_fec_decode_b_0_0_3 = lilacsat.fec_decode_b(214, True, False, False)
        self.lilacsat_fec_decode_b_0_0_2 = lilacsat.fec_decode_b(214, True, False, False)
        self.lilacsat_fec_decode_b_0_0_1 = lilacsat.fec_decode_b(214, True, False, False)
        self.lilacsat_fec_decode_b_0_0_0_2 = lilacsat.fec_decode_b(214, True, False, False)
        self.lilacsat_fec_decode_b_0_0_0_1 = lilacsat.fec_decode_b(214, True, False, False)
        self.lilacsat_fec_decode_b_0_0_0_0 = lilacsat.fec_decode_b(214, True, False, False)
        ...
        self.digital_pfb_clock_sync_xxx_0_2 = digital.pfb_clock_sync_ccf(sps, timing_loop_bw, (rrc_taps), nfilts, nfilts/2, 0.05, 2)
        self.digital_pfb_clock_sync_xxx_0_1 = digital.pfb_clock_sync_ccf(sps, timing_loop_bw, (rrc_taps), nfilts, nfilts/2, 0.05, 2)
        self.digital_pfb_clock_sync_xxx_0_0 = digital.pfb_clock_sync_ccf(sps, timing_loop_bw, (rrc_taps), nfilts, nfilts/2, 0.05, 2)
        self.digital_pfb_clock_sync_xxx_0 = digital.pfb_clock_sync_ccf(sps, timing_loop_bw, (rrc_taps), nfilts, nfilts/2, 0.05, 2)
        self.digital_lms_dd_equalizer_cc_0_0_2 = digital.lms_dd_equalizer_cc(2, equalizer_gain, 2, variable_constellation_0)
        self.digital_lms_dd_equalizer_cc_0_0_1 = digital.lms_dd_equalizer_cc(2, equalizer_gain, 2, variable_constellation_0)
        self.digital_lms_dd_equalizer_cc_0_0_0 = digital.lms_dd_equalizer_cc(2, equalizer_gain, 2, variable_constellation_0)
        ...
        self.digital_fll_band_edge_cc_0_2 = digital.fll_band_edge_cc(sps, alpha, 100, fll_bw)
        self.digital_fll_band_edge_cc_0_1 = digital.fll_band_edge_cc(sps, alpha, 100, fll_bw)
        self.digital_fll_band_edge_cc_0_0 = digital.fll_band_edge_cc(sps, alpha, 100, fll_bw)
        self.digital_fll_band_edge_cc_0 = digital.fll_band_edge_cc(sps, alpha, 100, fll_bw)
        self.digital_costas_loop_cc_0_0_2 = digital.costas_loop_cc(phase_bw, 2, False)
        self.digital_costas_loop_cc_0_0_1 = digital.costas_loop_cc(phase_bw, 2, False)
        self.digital_costas_loop_cc_0_0_0 = digital.costas_loop_cc(phase_bw, 2, False)
        self.digital_costas_loop_cc_0_0 = digital.costas_loop_cc(phase_bw, 2, False)
        self.blocks_unpack_k_bits_bb_0_0_0_3 = blocks.unpack_k_bits_bb(8)
        self.blocks_unpack_k_bits_bb_0_0_0_2 = blocks.unpack_k_bits_bb(8)
        self.blocks_unpack_k_bits_bb_0_0_0_1 = blocks.unpack_k_bits_bb(8)
        self.blocks_unpack_k_bits_bb_0_0_0_0_2 = blocks.unpack_k_bits_bb(8)
        self.blocks_unpack_k_bits_bb_0_0_0_0_1 = blocks.unpack_k_bits_bb(8)
        ...
        self.blocks_rms_xx_0_2 = blocks.rms_cf(0.0001)
        ...
        self.blocks_nlog10_ff_0_2 = blocks.nlog10_ff(20, 1, 0)
        ...
        self.blocks_multiply_const_vxx_0_2 = blocks.multiply_const_vcc((10, ))
        self.blocks_multiply_const_vxx_0_1 = blocks.multiply_const_vcc((10, ))
        self.blocks_multiply_const_vxx_0_0 = blocks.multiply_const_vcc((10, ))
        ...
        self.analog_sig_source_x_0_2 = analog.sig_source_c(samp_rate, analog.GR_COS_WAVE, -60e3, 1, 0)
        self.analog_sig_source_x_0_1 = analog.sig_source_c(samp_rate, analog.GR_COS_WAVE, -20e3, 1, 0)
        self.analog_sig_source_x_0_0 = analog.sig_source_c(samp_rate, analog.GR_COS_WAVE, 60e3, 1, 0)
        self.analog_sig_source_x_0 = analog.sig_source_c(samp_rate, analog.GR_COS_WAVE, 20e3, 1, 0)
        self.analog_feedforward_agc_cc_0_2 = analog.feedforward_agc_cc(1024, 1)
        self.analog_feedforward_agc_cc_0_1 = analog.feedforward_agc_cc(1024, 1)
        self.analog_feedforward_agc_cc_0_0 = analog.feedforward_agc_cc(1024, 1)
        ...
        self.msg_connect((self.lilacsat_fec_decode_b_0_0_0_0, 'out'), (self.blocks_message_debug_0, 'print_pdu'))
        self.msg_connect((self.lilacsat_fec_decode_b_0_0_0_0, 'out'), (self.blocks_socket_pdu_1, 'pdus'))
        self.msg_connect((self.lilacsat_fec_decode_b_0_0_0_1, 'out'), (self.blocks_message_debug_0, 'print_pdu'))
        self.msg_connect((self.lilacsat_fec_decode_b_0_0_0_1, 'out'), (self.blocks_socket_pdu_1, 'pdus'))
        self.msg_connect((self.lilacsat_fec_decode_b_0_0_0_2, 'out'), (self.blocks_message_debug_0, 'print_pdu'))
        self.msg_connect((self.lilacsat_fec_decode_b_0_0_0_2, 'out'), (self.blocks_socket_pdu_1, 'pdus'))
        self.msg_connect((self.lilacsat_fec_decode_b_0_0_1, 'out'), (self.blocks_message_debug_0, 'print_pdu'))
        self.msg_connect((self.lilacsat_fec_decode_b_0_0_1, 'out'), (self.blocks_socket_pdu_1, 'pdus'))
        self.msg_connect((self.lilacsat_fec_decode_b_0_0_2, 'out'), (self.blocks_message_debug_0, 'print_pdu'))
        self.msg_connect((self.lilacsat_fec_decode_b_0_0_2, 'out'), (self.blocks_socket_pdu_1, 'pdus'))
        self.msg_connect((self.lilacsat_fec_decode_b_0_0_3, 'out'), (self.blocks_message_debug_0, 'print_pdu'))
        self.msg_connect((self.lilacsat_fec_decode_b_0_0_3, 'out'), (self.blocks_socket_pdu_1, 'pdus'))
        self.msg_connect((self.lilacsat_kiss_decode_pdu_0_0, 'out'), (self.lilacsat_fec_encode_b_0, 'in'))
        ...
        self.connect((self.analog_feedforward_agc_cc_0_1, 0), (self.digital_fll_band_edge_cc_0_1, 0))
        self.connect((self.analog_feedforward_agc_cc_0_2, 0), (self.digital_fll_band_edge_cc_0_2, 0))
        ...
        self.connect((self.blocks_complex_to_real_0_0, 0), (self.lilacsat_vitfilt27_fb_0_1, 0))
        self.connect((self.blocks_complex_to_real_0_1, 0), (self.blocks_delay_0_1, 0))
        self.connect((self.blocks_complex_to_real_0_1, 0), (self.lilacsat_vitfilt27_fb_0_2, 0))
        self.connect((self.blocks_complex_to_real_0_2, 0), (self.blocks_delay_0_2, 0))
        self.connect((self.blocks_complex_to_real_0_2, 0), (self.lilacsat_vitfilt27_fb_0_3, 0))
        self.connect((self.blocks_delay_0, 0), (self.lilacsat_vitfilt27_fb_0_0, 0))
        self.connect((self.blocks_delay_0_0, 0), (self.lilacsat_vitfilt27_fb_0_0_0, 0))
        self.connect((self.blocks_delay_0_1, 0), (self.lilacsat_vitfilt27_fb_0_0_1, 0))
        self.connect((self.blocks_delay_0_2, 0), (self.lilacsat_vitfilt27_fb_0_0_2, 0))
        ...
        self.connect((self.blocks_multiply_const_vxx_0_0, 0), (self.lilacsat_plan13_cc_0_0, 0))
        self.connect((self.blocks_multiply_const_vxx_0_0, 0), (self.qtgui_freq_sink_x_0_0_0, 0))
        self.connect((self.blocks_multiply_const_vxx_0_1, 0), (self.lilacsat_plan13_cc_0_1, 0))
        self.connect((self.blocks_multiply_const_vxx_0_1, 0), (self.qtgui_freq_sink_x_0_0_1, 0))
        self.connect((self.blocks_multiply_const_vxx_0_2, 0), (self.lilacsat_plan13_cc_0_2, 0))
        self.connect((self.blocks_multiply_const_vxx_0_2, 0), (self.qtgui_freq_sink_x_0_0_2, 0))
        self.connect((self.blocks_multiply_xx_0, 0), (self.rational_resampler_xxx_0, 0))
        self.connect((self.blocks_multiply_xx_0_0, 0), (self.rational_resampler_xxx_0_0, 0))
        self.connect((self.blocks_multiply_xx_0_1, 0), (self.rational_resampler_xxx_0_1, 0))
        self.connect((self.blocks_multiply_xx_0_2, 0), (self.rational_resampler_xxx_0_2, 0))
        ...
        self.connect((self.blocks_nlog10_ff_0_1, 0), (self.qtgui_number_sink_0_1, 0))
        self.connect((self.blocks_nlog10_ff_0_2, 0), (self.qtgui_number_sink_0_2, 0))
        ...
        self.connect((self.blocks_rms_xx_0_1, 0), (self.blocks_nlog10_ff_0_1, 0))
        self.connect((self.blocks_rms_xx_0_2, 0), (self.blocks_nlog10_ff_0_2, 0))
        ...
        self.connect((self.blocks_unpack_k_bits_bb_0_0_0_0_0, 0), (self.lilacsat_fec_decode_b_0_0_1, 0))
        self.connect((self.blocks_unpack_k_bits_bb_0_0_0_0_1, 0), (self.lilacsat_fec_decode_b_0_0_2, 0))
        self.connect((self.blocks_unpack_k_bits_bb_0_0_0_0_2, 0), (self.lilacsat_fec_decode_b_0_0_3, 0))
        self.connect((self.blocks_unpack_k_bits_bb_0_0_0_1, 0), (self.lilacsat_fec_decode_b_0_0_0_0, 0))
        self.connect((self.blocks_unpack_k_bits_bb_0_0_0_2, 0), (self.lilacsat_fec_decode_b_0_0_0_1, 0))
        self.connect((self.blocks_unpack_k_bits_bb_0_0_0_3, 0), (self.lilacsat_fec_decode_b_0_0_0_2, 0))
        self.connect((self.digital_costas_loop_cc_0_0, 0), (self.digital_lms_dd_equalizer_cc_0_0, 0))
        self.connect((self.digital_costas_loop_cc_0_0_0, 0), (self.digital_lms_dd_equalizer_cc_0_0_0, 0))
        self.connect((self.digital_costas_loop_cc_0_0_1, 0), (self.digital_lms_dd_equalizer_cc_0_0_1, 0))
        self.connect((self.digital_costas_loop_cc_0_0_2, 0), (self.digital_lms_dd_equalizer_cc_0_0_2, 0))
        ...
        self.connect((self.digital_fll_band_edge_cc_0_0, 0), (self.digital_pfb_clock_sync_xxx_0_0, 0))
        self.connect((self.digital_fll_band_edge_cc_0_0, 0), (self.qtgui_freq_sink_x_0_0_0, 1))
        self.connect((self.digital_fll_band_edge_cc_0_1, 0), (self.digital_pfb_clock_sync_xxx_0_1, 0))
        self.connect((self.digital_fll_band_edge_cc_0_1, 0), (self.qtgui_freq_sink_x_0_0_1, 1))
        self.connect((self.digital_fll_band_edge_cc_0_2, 0), (self.digital_pfb_clock_sync_xxx_0_2, 0))
        self.connect((self.digital_fll_band_edge_cc_0_2, 0), (self.qtgui_freq_sink_x_0_0_2, 1))
        self.connect((self.digital_gmsk_mod_0, 0), (self.uhd_usrp_sink_1, 0))
        ...
        self.connect((self.digital_lms_dd_equalizer_cc_0_0_0, 0), (self.qtgui_const_sink_x_0_0, 0))
        self.connect((self.digital_lms_dd_equalizer_cc_0_0_1, 0), (self.blocks_complex_to_real_0_1, 0))
        self.connect((self.digital_lms_dd_equalizer_cc_0_0_1, 0), (self.qtgui_const_sink_x_0_1, 0))
        self.connect((self.digital_lms_dd_equalizer_cc_0_0_2, 0), (self.blocks_complex_to_real_0_2, 0))
        self.connect((self.digital_lms_dd_equalizer_cc_0_0_2, 0), (self.qtgui_const_sink_x_0_2, 0))
        ...
        self.connect((self.digital_pfb_clock_sync_xxx_0_1, 0), (self.digital_costas_loop_cc_0_0_1, 0))
        self.connect((self.digital_pfb_clock_sync_xxx_0_2, 0), (self.digital_costas_loop_cc_0_0_2, 0))
        self.connect((self.lilacsat_fec_encode_b_0, 0), (self.blocks_pack_k_bits_bb_0, 0))
        self.connect((self.lilacsat_plan13_cc_0, 0), (self.low_pass_filter_0, 0))
        self.connect((self.lilacsat_plan13_cc_0_0, 0), (self.low_pass_filter_0_0, 0))
        self.connect((self.lilacsat_plan13_cc_0_1, 0), (self.low_pass_filter_0_1, 0))
        self.connect((self.lilacsat_plan13_cc_0_2, 0), (self.low_pass_filter_0_2, 0))
        ...
        self.connect((self.lilacsat_vitfilt27_fb_0_0_0, 0), (self.blocks_unpack_k_bits_bb_0_0_0_0_0, 0))
        self.connect((self.lilacsat_vitfilt27_fb_0_0_1, 0), (self.blocks_unpack_k_bits_bb_0_0_0_0_1, 0))
        self.connect((self.lilacsat_vitfilt27_fb_0_0_2, 0), (self.blocks_unpack_k_bits_bb_0_0_0_0_2, 0))
        self.connect((self.lilacsat_vitfilt27_fb_0_1, 0), (self.blocks_unpack_k_bits_bb_0_0_0_1, 0))
        self.connect((self.lilacsat_vitfilt27_fb_0_2, 0), (self.blocks_unpack_k_bits_bb_0_0_0_2, 0))
        self.connect((self.lilacsat_vitfilt27_fb_0_3, 0), (self.blocks_unpack_k_bits_bb_0_0_0_3, 0))
        ...
        self.connect((self.low_pass_filter_0_1, 0), (self.analog_feedforward_agc_cc_0_1, 0))
        self.connect((self.low_pass_filter_0_1, 0), (self.blocks_rms_xx_0_1, 0))
        self.connect((self.low_pass_filter_0_2, 0), (self.analog_feedforward_agc_cc_0_2, 0))
        self.connect((self.low_pass_filter_0_2, 0), (self.blocks_rms_xx_0_2, 0))
        ...
        self.connect((self.rational_resampler_xxx_0_2, 0), (self.blocks_multiply_const_vxx_0_2, 0))
        ...
        self.connect((self.uhd_usrp_source_0, 0), (self.blocks_multiply_xx_0_2, 0))
    ...
    def set_tx_offset(self, tx_offset):
        ...
        Qt.QMetaObject.invokeMethod(self._tx_offset_line_edit, "setText", Qt.Q_ARG("QString", str(self.tx_offset)))
        self.uhd_usrp_sink_1.set_center_freq(259.5e6+self.tx_offset, 0)
    ...
    def set_timing_loop_bw(self, timing_loop_bw):
        ...
        self.digital_pfb_clock_sync_xxx_0_2.set_loop_bandwidth(self.timing_loop_bw)
        self.digital_pfb_clock_sync_xxx_0_1.set_loop_bandwidth(self.timing_loop_bw)
    ...
    def set_rrc_taps(self, rrc_taps):
        ...
        self.digital_pfb_clock_sync_xxx_0_2.update_taps((self.rrc_taps))
        self.digital_pfb_clock_sync_xxx_0_1.update_taps((self.rrc_taps))
    ...
    def set_phase_bw(self, phase_bw):
        ...
        self.digital_costas_loop_cc_0_0_2.set_loop_bandwidth(self.phase_bw)
    ...
    def set_if_rate(self, if_rate):
        ...
        self.qtgui_freq_sink_x_0_0_2.set_frequency_range(0, self.if_rate)
        self.qtgui_freq_sink_x_0_0_1.set_frequency_range(0, self.if_rate)
        self.qtgui_freq_sink_x_0_0_0.set_frequency_range(0, self.if_rate)
        self.qtgui_freq_sink_x_0_0.set_frequency_range(0, self.if_rate)
        self.low_pass_filter_0_2.set_taps(firdes.low_pass(1, self.if_rate, 10e3, 2e3, firdes.WIN_HAMMING, 6.76))
        self.low_pass_filter_0_1.set_taps(firdes.low_pass(1, self.if_rate, 10e3, 2e3, firdes.WIN_HAMMING, 6.76))
        self.low_pass_filter_0_0.set_taps(firdes.low_pass(1, self.if_rate, 10e3, 2e3, firdes.WIN_HAMMING, 6.76))
    ...
    def set_fll_bw(self, fll_bw):
        self.fll_bw = fll_bw
        self.digital_fll_band_edge_cc_0_2.set_loop_bandwidth(self.fll_bw)
        self.digital_fll_band_edge_cc_0_1.set_loop_bandwidth(self.fll_bw)
        self.digital_fll_band_edge_cc_0_0.set_loop_bandwidth(self.fll_bw)
    ...
    def set_equalizer_gain(self, equalizer_gain):
        ...
        self.digital_lms_dd_equalizer_cc_0_0_2.set_gain(self.equalizer_gain)
        self.digital_lms_dd_equalizer_cc_0_0_1.set_gain(self.equalizer_gain)
        self.digital_lms_dd_equalizer_cc_0_0_0.set_gain(self.equalizer_gain)
...
def main(top_block_cls=send_data_100k, options=None):
