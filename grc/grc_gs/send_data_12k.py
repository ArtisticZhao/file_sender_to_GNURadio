...
class send_data_12k(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        for c in range(0, 1):
            self.tab_grid_layout_1.setColumnStretch(c, 1)
        self._if_freq_options = (20e3, 60e3, -20e3, -40e3, )
        self._if_freq_labels = ('401.58M (30)', '401.54M (31)', '401.62M (32)', '401.66M (33)', )
        ...
        for label in self._if_freq_labels: self._if_freq_combo_box.addItem(label)
        self._if_freq_callback = lambda i: Qt.QMetaObject.invokeMethod(self._if_freq_combo_box, "setCurrentIndex", Qt.Q_ARG("int", self._if_freq_options.index(i)))
        ...
        self.tab_grid_layout_0.addWidget(self._qtgui_number_sink_0_win, 0, 1, 1, 1)
        for r in range(0, 1):
            self.tab_grid_layout_0.setRowStretch(r, 1)
        for c in range(1, 2):
            self.tab_grid_layout_0.setColumnStretch(c, 1)
        ...
        self.tab_grid_layout_0.addWidget(self._qtgui_freq_sink_x_0_0_win, 3, 0, 1, 2)
        for r in range(3, 4):
            self.tab_grid_layout_0.setRowStretch(r, 1)
        for c in range(0, 2):
            self.tab_grid_layout_0.setColumnStretch(c, 1)
        ...
        self.tab_grid_layout_0.addWidget(self._qtgui_const_sink_x_0_win, 2, 0, 1, 2)
        for r in range(2, 3):
            self.tab_grid_layout_0.setRowStretch(r, 1)
        for c in range(0, 2):
            self.tab_grid_layout_0.setColumnStretch(c, 1)
        ...
        self.lilacsat_plan13_cc_0_2_0 = lilacsat.plan13_cc(True, tle_line1, tle_line2, lon, lat, alt, 259500000, samp_rate, True, True)
        ...
        self.analog_sig_source_x_0 = analog.sig_source_c(samp_rate, analog.GR_COS_WAVE, if_freq, 1, 0)
        ...
        self.connect((self.lilacsat_plan13_cc_0_2_0, 0), (self.uhd_usrp_sink_1, 0))
        ...
        self.connect((self.rational_resampler_xxx_0_0_0, 0), (self.lilacsat_plan13_cc_0_2_0, 0))
